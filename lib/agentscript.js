...
(function() {
  ...
  ABM.Patch = (function() {
    ...
    Patch.prototype.labelContext = null;
    ...
    Patch.prototype.draw = function(ctx) {
      ...
      return this.drawLabel(this.labelContext || ctx);
    };
  ...
  ABM.Patches = (function(_super) {
    ...
    Patches.prototype.setNeighbors = function() {
      ...
      for (_i = 0, _len = this.length; _i < _len; _i++) {
        ...
        _results.push(p.n4 = [p.n[1], p.n[3], p.n[4], p.n[6]]);
      }
      return _results;
    };
  ...
  ABM.Model = (function() {
    ...
    function Model(div, size, minX, maxX, minY, maxY, isTorus, hasNeighbors) {
      ...
      this.globalNames = (u.ownKeys(this)).concat("globalNames");
    ...
    Model.prototype.setWorld = function(size, minX, maxX, minY, maxY, isTorus, hasNeighbors) {
      var height, maxXcor, maxYcor, minXcor, minYcor, numX, numY, pxHeight, pxWidth, width;
      if (isTorus == null) {
        isTorus = true;
      }
      if (hasNeighbors == null) {
    ...
    Model.prototype.stopped = function() {
      return this.anim.stopped;
    };
